...
module.exports = tobz = async (tobz, message) => {
    try {
        ...
        const ownerNumber = '628983100508@c.us'
	...
	const sotoy = [
        ...
        const mess = {
            ...
            error: {
                ...
                Ow: 'Maaf, bot tidak dapat mengeluarkan owner *SYMPHONY BOT*!',
                Bk: 'Maaf, bot tidak dapat memblokir Owner *SYMPHONY BOT*!',
        ...
        function isBadwordMsg(id){
            ...
            for (let i of msgBadword){
                if(i.id === id){
                    ...
                    if (msg >= 12) { // 12x
                        kasar === true 
                        tobz.reply(from, '*「 𝗔𝗡𝗧𝗜 𝗕𝗔𝗗𝗪𝗢𝗥𝗗 」*\nKamu telah berkata kasar di grup ini, kamu akan di kick otomatis oleh Symphony!', message.id).then(() => {
                            tobz.removeParticipant(groupId, id)
                        }).then(() => {
                            const cus = id
                            var found = false
	...
	if (isGroupMsg && AntiStickerSpam && !isGroupAdmins && !isAdmin && !isOwner){
        ...
        if(!isCmd && isKasar && isGroupMsg && isBadword && !isGroupAdmins) { 
            ...
            if(isBadwordMsg(serial)) return
                ...
                if (body === '!unbanchat') {
                    if (!isOwner) return tobz.reply(from, 'Perintah hanya dapat digunakan oleh owner *SYMPHONY BOT*!', id)
        ...
        case prefix+'banchat':
            ...
            if (!isOwner) return tobz.reply(from, 'Perintah hanya dapat digunakan oleh *SYMPHONY BOT*!', id)
        ...
        case prefix+'ttp':
                ...
                if(cekumur(cekage)) return
                if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
                if (args.length === 1) return tobz.reply(from, `Kirim perintah !ttp <teks kamu>\nContoh : !ttp syahrul ganteng`, id)
                try
                {
        ...
        case prefix+'ttp2':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah !ttp2 <teks kamu>\nContoh : !ttp2 syahrul ganteng`, id)
        ...
        case prefix+'ttg':
            ...
            try {
                if (quotedMsgObj == null) {
                    if (args.length === 1) return tobz.reply(from, `Kirim perintah !ttg <teks kamu>\nContoh : !ttg syahrul ganteng`, id)
        ...
        case prefix+'lovemessage':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}lovemessage <teksnya>, contoh ${prefix}lovemessage Symphony ganteng`, id)
        ...
        case prefix+'romance':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}romance <teksnya>, contoh ${prefix}romance Symphony ganteng`, id)
            tobz.reply(from, mess.wait, id)
        ...
        case prefix+'party':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}party <teksnya>, contoh ${prefix}party Symphony ganteng`, id)
            tobz.reply(from, mess.wait, id)
        ...
        case prefix+'silk':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}silk <teksnya>, contoh ${prefix}silk Symphony ganteng`, id)
            tobz.reply(from, mess.wait, id)
        ...
        case prefix+'blackpink':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}blackpink <teksnya>, contoh ${prefix}blackpink Symphony ganteng`, id)
            tobz.reply(from, mess.wait, id)
        ...
        case prefix+'thunder':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}thunder <teksnya>, contoh ${prefix}thunder Syahrul ganteng`, id)
            tobz.reply(from, mess.wait, id)
        ...
        case prefix+'pornhub':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}pornhub /teks1 /teks2, contoh ${prefix}thunder /Symphony /ganteng`, id)
            ...
            if (argz.length >= 2) {
                ...
                await tobz.reply(from, `Kirim perintah ${prefix}pornhub /teks1 /teks2, contoh ${prefix}thunder /Symphony /ganteng`, id)
            }
            break
        case prefix+'glitch':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}glitch /teks1 /teks2, contoh ${prefix}glitch /Symphony /ganteng`, id)
            argz = body.trim().split('/')
            if (argz.length >= 2) {
                tobz.reply(from, mess.wait, id)
                ...
                await tobz.reply(from, `Kirim perintah ${prefix}glitch /teks1 /teks2, contoh ${prefix}glitch /Symphony /ganteng`, id)
            }
            break
        case prefix+'daftar':
                argz = body.trim().split('/')
...
${desc}`)
        ...
        case prefix+'tts':
            ...
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            try {
                if (args.length === 1) return tobz.reply(from, 'Kirim perintah !tts <kode bahasa> <teksnya>, Contoh !tts id Syahrul ganteng\nUntuk melihat kode bahasa ketik !bahasa')
                var dataBhs = args[1]      
        ...
        case prefix+'ownerbot':
            tobz.sendContact(chatId, `628983100508@c.us`)
        ...
        case prefix+'resetstiker':
            ...
            if(cekumur(cekage)) return
            if (!isAdmin) return tobz.reply(from, `Perintah hanya dapat digunakan oleh member *premium*!\nKetik !daftarpremium untuk menjadi member premium!`, id)
            if (!args.length === 1) return tobz.reply(from, `Kirim perintah !resetsticker @tagmember`, id) 
            const nomebr = args[1]
...
🌐️ *URL*: ${url}`
        ...
        case prefix+'quran':
            ...
            if (!isGroupMsg) return tobz.reply(from, `Perintah hanya dapat digunakan didalam grup!`, id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah !quran <urutan surah>\nContoh : !quran 1`, id)
        ...
        case prefix+'tafsir': // ARUGAZ
            ...
            if (!isGroupMsg) return tobz.reply(from, `Perintah hanya dapat digunakan didalam grup!`, id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length == 1) return tobz.reply(from, `Kirim perintah !tafsir <nama surah> <ayat surah>\nContoh : !tafsir al-fatihah 2`, message.id)
        ...
        case prefix+'ytsearch':
            ...
            if (!isGroupMsg) return tobz.reply(from, `Perintah hanya dapat digunakan didalam grup!`, id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}ytsearch <query>, Contoh : !ytsearch Despacito`)
        ...
        case prefix+'shopee':
            ...
            if (!isGroupMsg) return tobz.reply(from, `Perintah hanya dapat digunakan didalam grup!`, id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}shopee <nama barang>, Contoh : !shopee Iphone 12 Pro max`)
        ...
        case prefix+'playstore':
            ...
            if (!isGroupMsg) return tobz.reply(from, `Perintah hanya dapat digunakan didalam grup!`, id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}playstore <aplikasi>, Contoh : !playstore tiktok`)
	...
	case prefix+'bitly':
        ...
        case prefix+'play':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            if (!isAdmin) return tobz.reply(from, `Perintah ini hanya bisa di gunakan oleh Admin Symphony!`, id)
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group', id)
	...
	case prefix+'moddroid':
        ...
        case prefix+'nhentai': // SEARCH NHENTAI
            ...
            if(cekumur(cekage)) return
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            tobz.reply(from, 'PREMIUM COMMAND, HUBUNGI : wa.me/628983100508', id)
          break
        ...
        case prefix+'ramalpasangan':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, 'kirim perintah !ramalpasangan symphony & roxy :p', id)
            argz = body.trim().split('&')
            if (argz.length >= 2) {
            tobz.reply(from, mess.wait, id)
            const kamu = argz[0]
        ...
        case prefix+'artinama':
            ...
            if(cekumur(cekage)) return
                if (!isGroupMsg) return tobz.reply(from, `Perintah hanya dapat digunakan didalam grup!`, id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}artinama <nama>, Contoh : ${prefix}artinama Syahrul`, id)
            try {
...
➸ *Wilayah:* +${region_name}`
        ...
        case prefix+'quotemaker':
            ...
            if (argz.length >= 4) {
                ...
                tobz.reply(from, 'Kirim perintah !quotemaker /nama/teksnya/temanya\nContoh ; !quotemaker /Syahrul/Hay cantik/Laut', id)
            }
            break
        ...
        case prefix+'bc': // KASIH CREDIT DONG KALO COPAS
            if (!isOwner) return tobz.reply(from, `Perintah ini hanya untuk Owner Symphony`, id)
                bctxt = body.slice(4)
                txtbc = `*「 SSR BOT BROADCAST 」*\n\n${bctxt}`
        ...
        case prefix+'ownergrup':
            ...
            break
        case prefix+'otagall': // FOR OWNER & ADMIN SYMPHONY
        case prefix+'omentionall':
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (!isOwner, !isAdmin) return tobz.reply(from, 'Perintah ini hanya untuk Owner Symphony', id)
        ...
        case prefix+'okickall':
            if (!isGroupMsg) return tobz.reply(from, 'Perintah hanya dapat digunakan didalam grup!', id)
            if (!isOwner) return tobz.reply(from, 'Perintah ini hanya untuk Admin Symphony', id)
            if (!isBotGroupAdmins) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan ketika bot menjadi admin', id)
        ...
        case prefix+'oadd':
            ...
            if (!isOwner, !isAdmin) return tobz.reply(from, 'Perintah ini hanya untuk Admin Symphony', id)
            if (!isBotGroupAdmins) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan ketika bot menjadi admin', id)
            try {
        ...
        case prefix+'okeluarkanbot':
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group', id)
            if (!isOwner, !isAdmin) return tobz.reply(from, 'Perintah ini hanya untuk Admin Symphony', id)
            await tobz.sendText(from,'SYMPHONY DIPERINTAHKAN KELUAR OLEH OWNER!!').then(() => tobz.leaveGroup(groupId))
            break
        ...
        case prefix+'sider':
            if (!isGroupMsg) return tobz.reply(from, `Perintah hanya dapat digunakan didalam grup!`, id)                
            if (!quotedMsg) return tobz.reply(from, `Tolong Reply Pesan Symphony`, id)
            if (!quotedMsgObj.fromMe) return tobz.reply(from, `Tolong Reply Pesan Symphony`, id)
            try {
                ...
                console.log(err)
                tobz.reply(from, `Maaf, Belum Ada Yang Membaca Pesan Symphony atau Mereka Menonaktifkan Read Receipts`, id)    
            }
            break
        ...
        case prefix+'getses':
            ...
            break
        case prefix+'symphonyadmin':
            let admn = `This is list of Symphony Admin\nTotal : ${adminNumber.length}\n`
        ...
        case prefix+'limit':
            ...
            break
        case prefix+'kasihlimit': // Hanya Admin & Owner Symphony yang bisa gift Limit
...
• Limit: ${limitCount-updated.limit}`
        ...
        case prefix+'ban':
            if (!isAdmin) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan oleh admin Symphony!', id)
            for (let i = 0; i < mentionedJidList.length; i++) {
                if ((adminNumber).includes(mentionedJidList[i])) return tobz.reply(from,`Maaf ${pushname}, Kamu tidak bisa banned Admin Symphony!`, id)
        ...
        case prefix+'bugreport':
         ...
         case prefix+'profile':
            ...
            break
	// Fadhlur Owner of NotBot Bug? https://wa.me/628983100508
        case '#slot':
	...
	//list menu
        case prefix+'waktubot':
            tobz.reply(from, `Symphony telah aktif selama :\n${cts}`, id)
            break
        case prefix+'menu':
        case prefix+'help':
            tobz.sendText(from, helpcmd(prefix, cts, pendaftar))
            break
        case prefix+'symphonygroup':
            tobz.reply(from, `Link Group Symphony : https://chat.whatsapp.com/By906EiJBGBCZURDadOat\nJangan Lupa Join Ya Kak ${pushname}`, id)
            break
        ...
        case prefix+'premiummenu':
            if (!isAdmin) return tobz.reply(from, 'Perintah ini hanya untuk Admin SYMPHONY', id)
...
//BY SYAHRUL SARIZ
        ...
        case prefix+'nulis1':
            ...
            if (!isAdmin) return tobz.reply(from, 'Perintah hanya dapat digunakan oleh member *premium*!\nKetik !daftarpremium untuk menjadi member premium!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf kuota limit kamu sudah habis, hubungi owner untuk mendapatkan limit lagi!\nNomor owner dapat didapatkan dengan mengetik ${prefix}owner`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah ${prefix}nulis1 /nama/kelas/teksnya, contoh ${prefix}nulis1 /last/12akuntansi/Ujian tengah pe`, id)
            argz = body.trim().split('/')
            if (argz.length >= 2) {
                tobz.reply(from, mess.wait, id)
        ...
        case prefix+'nulis2':
            ...
            break
        default:
            //if (!isGroupMsg) return tobz.reply(from, 'Jika Ingin Menggunakan Bot Harap Masuk Ke Dalam Grup 18+, Link Ada Di Bio atau Bisa Mengetik #elainagroup!\nJika Ingin Sewa Bot atau Bikin Bot Harap Ketik *#noiklan*', id)
